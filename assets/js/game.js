...
var questions = [
  {
      question: "Which is not a standard selector?",
      answer: "Location selector",
      options: ["Id selector","Universal selector","Class Selector","Location selector"]
  },
  {
      question: "What is the correct way to call the random method on the Math global object?",
      answer: "Math.random()",
      options: [
        'random.Math()', 'Math(randon)', 'Math.random()', 'math.random()'
      ]
  },
  {
...
document.addEventListener("submit", function (event) {
  ...
  var usernameinput = JSON.parse(localStorage.getItem("userInfo"));
  ...
  usernameinput.push(userInfo);

  localStorage.setItem('userInfo', JSON.stringify(usernameinput));
});
